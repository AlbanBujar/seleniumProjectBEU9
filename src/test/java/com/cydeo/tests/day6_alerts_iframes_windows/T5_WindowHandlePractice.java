...
public class T5_WindowHandlePractice {
    ...
    public void multiple_window_test() {
        ...
        //Storing the main page`s window handle as strinf is
        ...
        System.out.println("Title after click: " + clickHereLink);
    ...
    public void tearDown(){
        //driver.quit() butun acik sayfalari kapatir
        driver.close(); // son acik sayfayi kapatir
    }
